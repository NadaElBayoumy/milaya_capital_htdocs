...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'milayacapital_8Dec2023_612932896d1e14db3978_20231208102247_archive.zip';
        const ARCHIVE_SIZE       = '69471038';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6129328-08102247';
        const SECONDARY_PACKAGE_HASH = '9250311-08102247';
